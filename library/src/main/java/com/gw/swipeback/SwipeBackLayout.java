    ...
    if (isEnable) {
      switch (mDirectionMode) {
        case FROM_LEFT:
          ...
          break;
        case FROM_TOP:
          isEnable = touchedEdge == ViewDragHelper.EDGE_TOP;
          break;
        case FROM_RIGHT:
          isEnable = touchedEdge == ViewDragHelper.EDGE_RIGHT;
          break;
        case FROM_BOTTOM:
          isEnable = touchedEdge == ViewDragHelper.EDGE_BOTTOM;
          break;
      }
    }
    return isEnable && mIsEnabled;
  }
